...
import type { Source } from "@/lib/sse.ts";
import { splitFences } from "@/lib/markdownUtils.ts";
...
// src/components/ExportPDF.tsx  — REPLACE THE DEFAULT EXPORT FUNCTION BELOW ONLY
export default function ExportPDF({ chatTitle, messages, sourcesByIndex = {} }: Props) {
    ...
    return (
        ...
        >
            {/* Make the icon inherit the text color (white in light mode, black in dark mode) */}
            <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
